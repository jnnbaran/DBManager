   ...
   <!-- <tr>
    ...
    <div class="card"style="width: 60rem;" >
        <h5 class="card-header"> <%=resultSet.getString("Date") %> </h5>
            <div class="card-body">
                <h5 class="card-title"><strong> <%=resultSet.getString("Title") %></strong>  <button class="far fa-trash-alt" style="width: 2rem;height: 2rem;" onclick="if (!(confirm('Are you sure you want to delete this question?'))) return false"></button></h5>
